using _Small_Projects._DependencyInjection_tests.Unity_Dependecy_Injection.Scripts;
using UnityEngine;
...
//     {
// #if UNITY_EDITOR
//         // Draw ground check capsule
//         Gizmos.color = Color.yellow; // Default color
//
...
//         if (isCapsuleCastHit)
//         {
//             Gizmos.color = Color.green; // Set color to green when grounded
//         }
//         else
//         {
//             Gizmos.color = Color.red; // Set color to red when not grounded
//         }
//
//         DrawBoldLine(point1 + Vector3.right * _groundCheckRadius / 2, point2 + Vector3.right * _groundCheckRadius / 2);
//         DrawBoldLine(point1 - Vector3.right * _groundCheckRadius / 2, point2 - Vector3.right * _groundCheckRadius / 2);
//         DrawBoldLine(point1 + Vector3.forward * _groundCheckRadius / 2, point2 + Vector3.forward * _groundCheckRadius / 2);
//         DrawBoldLine(point1 - Vector3.forward * _groundCheckRadius / 2, point2 - Vector3.forward * _groundCheckRadius / 2);
// #endif
//     }

// Helper method to draw a bold line
    // private void DrawBoldLine(Vector3 start, Vector3 end)
    // {
    ...
    //
    //     Vector3 offset = perpendicular * _gizmoLineThickness / 2f;
    //
    ...
    private void HandleInput()
    {
        ...
        if (_isGrounded)
        {
            ...
            if (InputHandler.Instance.JumpTriggerd)
